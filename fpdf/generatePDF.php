<?php
    ...
    function printPDF($lname, $fname, $adress, $phone, $roomName, $night, $price){
        require('fpdf.php');
        ...
        class PDF extends FPDF {
            ...
            function AddClientInformation($nume, $prenume, $adresa, $telefon){
        ...
        $pdf->AddClientInformation($lname, $fname, $adress, $phone);
        $pdf->CreateTable($roomName, $night, $price);
        $pdf->Output();
    }

    printPDF("Cringanu", "Denis-Florin", "Strada principala, Tanasoaia, Vrancea, 672555", "0765230530", "Camera Luxury pentru 2 persoane", 4, 200);
